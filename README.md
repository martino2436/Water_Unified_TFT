...
Load trained R-TFT and L-TFT models
Generate predictions (regression + classification)
Bayesian MCMC sensor fusion → C-TFT posterior predictions
Denormalisation and forecast visualisation
Interpretability analysis (variable selection weights + temporal attention)
Model Variants
Model	Description
