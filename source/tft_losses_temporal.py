"""
Custom loss functions and metrics for TFT Temporal model (Regression Only).
File: tft_losses_temporal.py

This version is for the temporal model that only does regression (no classification).

Usage:
    from tft_losses_temporal import (
